...
class _FindIdPwPageState extends State<FindIdPwPage> {
  ...
  Future<void> findPassword() async {
    ...
    final response = await http.post(
      ...
      body: jsonEncode({"username": username}), // 실제 파라미터명에 맞게 수정
    );
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) =>
                value == null || value.isEmpty ? '사용자 이름(아이디)를 입력하세요.' : null,
              ),
              const SizedBox(height: 24),
              isLoading
              ...
              if (resultMessage.isNotEmpty)
                Text(
                  resultMessage,
                  style: TextStyle(
                    color: resultMessage.contains('발송') ? Colors.green : Colors.red,
                  ),
                ),
            ],
          ),
