...
CREATE TABLE "device_data" (
  ...
  "device_gps_id" INTEGER UNIQUE,  -- 일대일 관계 강제로, 여러 값을 가질 수 있다면 UNIQUE 제거 필요
  "door_status" BOOLEAN,
...
CREATE TABLE "alert" (
  ...
  "device_id" INTEGER NOT NULL,
  "alert_code" VARCHAR,
  "alert_type" VARCHAR,  -- ENUM으로 저장
  "device_data_id" INTEGER,
  "message" TEXT,
  "alert_severity" VARCHAR,  -- ENUM으로 저장
  "is_read" BOOLEAN,
  "is_resolved" BOOLEAN,
  "created_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  "updated_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE "user_activity_log" (
  "id" SERIAL PRIMARY KEY,
  "user_id" INTEGER NOT NULL,
  "activity_type" VARCHAR,  -- ENUM으로 저장
  "created_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  "updated_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- COMMENT ON COLUMN "user_activity_log"."id" IS '기본 키, 자동 증가';
